package com.avtograv.features.moviedetails.view
...
import com.avtograv.features.moviedetails.viewmodel.MovieDetailsViewModelFactory
import com.avtograv.features.moviedetails.viewmodel.MovieDetailsViewModelImpl
import com.avtograv.features.moviedetails.viewmodel.MovieDetailsViewState.*
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.stateOutput.observe(viewLifecycleOwner, { state ->
            when (state) {
                ...
                is NoMovie -> showMovieNotFoundError()
